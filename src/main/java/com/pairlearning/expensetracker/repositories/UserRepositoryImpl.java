...
public class UserRepositoryImpl implements UserRepository {
    ...
    private static final String SQL_FIND_BY_USER = "SELECT * FROM ET_USERS WHERE EMAIL = ?";
    @Autowired
    ...
    @Override
    public User findByUser(String email, String password) throws EtAuthException {
        try {
            User user = jdbcTemplate.queryForObject(SQL_FIND_BY_USER, new Object[]{email}, userRowMapper);
